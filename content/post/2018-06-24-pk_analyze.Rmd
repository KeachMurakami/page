...
(prob <- dnorm(stat_wc$pk_per_match[21], mean(mcmc_sample_2018), sd(mcmc_sample_2018)))
```
...
現在のPK発生率はランダムウォークモデルでは、`r round(prob*100, 2)`%ほどの確率でしか生起しない事象らしい。
