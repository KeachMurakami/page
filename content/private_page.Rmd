...
- 20000–30000円
- 1次会は3000円/3500円/4000円
- ビンゴ？
    - するかしないか
    - ビンゴセット的なやつ (誰かもってそう)
    - 賞品選び
        - 振りたい
- 昨年幹事 (あやかさんとふじたさん) に聞きたい


<iframe seamless src="../leaflet/bounenkai_map/index.html" width="800px" height="1000px"></iframe>
...
known <-
  ...
  mutate(name = paste0(name, " <a href=", url, ">web</a><br>", memo))
unknown <-
