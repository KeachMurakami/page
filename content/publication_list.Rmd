...
<FONT color="grey">Last update: `r lubridate::today()`  <br>Add link: ComBio2018 poster</FONT>
</div>
...
papers <-
  ...
  dplyr::transmute(title = str_glue('<a href="http://doi.org/{doi}">{title}</a>'),
                   author, year, type, journal, corresponding, bibtexkey, self_archive) %>%
  
  dplyr::mutate(title = if_else(!is.na(self_archive), paste0(title, '&emsp;<a href="', self_archive, '"><i class="ai ai-google-scholar-square ai-3x"></i></a>'), as.character(title))) %>%
