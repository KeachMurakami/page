...
symposium_map <-
  symposium_location_domestic %>%
    ...
    addCircleMarkers(lng = ~lng, lat = ~lat, popup = ~name, group = "<FONT color='pink'>Domestic</FONT>",
                     col = "pink", opacity = .9) %>%
    addCircleMarkers(data = symposium_location_int, lng = ~lng, lat = ~lat, popup = ~name, group = "<FONT color='skyblue'>International</FONT>",
                     col = "skyblue", opacity = .9) %>%
    addLayersControl(
      overlayGroups = c("<FONT color='pink'>Domestic</FONT>", "<FONT color='skyblue'>International</FONT>"),
